...
export function Hero() {
  return (
    <section className="relative min-h-screen overflow-hidden rounded-b-[48px] bg-[#100706] text-white">
      ...
      {/* Main content */}
      <Container className="relative flex min-h-screen max-w-7xl flex-col pt-24 lg:pt-28 xl:max-w-[1528px] xl:px-6">
        <div className="flex flex-1 flex-col justify-end pb-8 xl:pb-0">
          ...
          <div className="relative">
            ...
            <motion.div
              className="absolute inset-0 z-0 hidden items-end justify-center xl:flex"
              initial="hidden"
              animate="visible"
            ...
            <div className="relative grid min-h-[500px] items-end gap-8 xl:min-h-[620px] xl:grid-cols-[minmax(0,1fr)_600px_minmax(0,1fr)] xl:grid-rows-[1fr_auto] xl:gap-0" style={{ zIndex: 10 }}>
              {/* Left column - Title */}
              <motion.div
                className="relative z-20 order-1 flex flex-col items-center text-center xl:order-1 xl:row-start-2 xl:items-start xl:self-start xl:pb-24 xl:text-left"
                initial="hidden"
                animate="visible"
                variants={fadeInUp}
                custom={0.1}
              >
                ...
                <h1 className="font-inter mt-3 text-[clamp(2.8rem,7vw,5.5rem)] font-extrabold uppercase leading-[0.88] tracking-[-0.03em] text-white xl:text-[clamp(2.875rem,calc(7.5vw_-_49px),4.125rem)]">
                  I Build
                  <br />
                  Production SaaS
                </h1>
              ...
              <motion.div
                className="relative order-2 flex items-end justify-center xl:hidden"
                initial="hidden"
                animate="visible"
                variants={fadeInScale}
              >
                <div className="pointer-events-none absolute bottom-[10%] left-1/2 h-[280px] w-[320px] -translate-x-1/2 rounded-full bg-[radial-gradient(ellipse_at_50%_55%,rgba(255,81,19,0.32)_0%,rgba(180,44,10,0.14)_50%,transparent_75%)] blur-[44px] lg:h-[500px] lg:w-[700px] lg:blur-[68px]" />
                <div className="absolute bottom-[12%] left-1/2 h-[220px] w-[220px] -translate-x-1/2 rounded-full bg-[radial-gradient(circle_at_43%_34%,#ff7b35_0%,#ff571c_42%,#e43a10_70%,#9f210a_100%)] shadow-[0_0_65px_rgba(255,73,15,0.18)] lg:h-[420px] lg:w-[420px]" />
                <div className="relative z-10 h-[340px] w-[260px] sm:h-[400px] sm:w-[300px] lg:h-[620px] lg:w-[480px]">
                  <Image
                    src="/images/amine-portrait.png"
                    alt="Amine - Senior Software Engineer"
                    fill
                    sizes="(min-width: 1024px) 480px, (max-width: 640px) 260px, 300px"
                    className="object-contain object-bottom [filter:contrast(1.04)_saturate(.88)_brightness(.98)]"
                    priority
                  />
              ...
              <div className="hidden xl:order-2 xl:row-start-2 xl:block" />

              {/* Right column - Description, CTA, secondary actions */}
              <motion.div
                className="hero-brief order-3 xl:row-start-2 xl:pb-24"
                initial="hidden"
                animate="visible"
                variants={fadeInUp}
                custom={0.3}
